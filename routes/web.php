...
use App\Http\Controllers\publicaciones_controller;


Route::get('/', function () {
    $post= new titulos();
    $post->titulo_barra="Inicio";
    $post->titulo_barra2="Unidad I";
    $post->titulo_barra3="Unidad II";
    ...
    $post->contenido="Portafolio de Investigaciones dedicado a la asignatura de Programación Cliente/Servidor.";
...
Route::get('/blog', function () {
    ...
    $post->titulo_barra2_post="Unidad I";
    $post->titulo_barra3_post="Unidad II";
    $post->titulo_post="Temas Unidad I";
...
Route::get('/blog2', function () {
    ...
    $post->titulo_post3_post="Componentes del Modelo Cliente/Servidor.";
    $post->titulo_post4_post="Concepto de Programa Maestro."; 
    $post->titulo_post5_post="Procesos y Tareas del Programa Maestro.."; 
    $post->titulo_post6_post="Tipos de Servidores."; 
    $post->titulo_post7_post="Características de la arquitectura Cliente/Servidor:."; 
    
    $post->fecha_publicacion_post="29.01.2022";
    $post->fecha_publicacion2_post="29.01.2022";
    $post->fecha_publicacion2_post="02.03.2022";
    $post->contenido="Pagina dedicada al examen de la unidad 1 de la materia Cliente-Servidor, en esta encontraras post dedicados a investigaciones relacionadas a la materia.";
...
Route::get('/blog3', function () {
    ...
    $post->titulo_barra2_post="Unidad I";
    $post->titulo_barra3_post="Unidad II";
    $post->titulo_post_post="Ventajas y Desventajas de la Arquitectura Cliente/Servidor.";
    $post->titulo_post2_post="Concepto de Cómputo en la Nube."; 
    $post->titulo_post3_post="Conceptos de Infrastructure as a Service (IAAS), Platform as a Service (PAAS), Software as a Service (SAAS)."; 
    $post->titulo_post4_post="Arquitectura Cliente/Servidor con los Modelos de Cómputo en la Nube IAAS, PAAS, SAAS.";  
    $post->fecha_publicacion_post="02.03.2022";
    $post->contenido="Portafolio de Investigaciones dedicado a la asignatura de Programación Cliente/Servidor.";
    return view('blog3',['post'=>$post]);
})->name('blog3');


Route::get('/indexu2', function () {
    $post= new post();
    $post->titulo_barra_post="Inicio";
    $post->titulo_barra2_post="Unidad I";
    $post->titulo_barra3_post="Unidad II";
    $post->titulo_post="Temas Unidad II";
    $post->titulo_post_post="Presentación Distribuida, Presentación Remota, Lógica o Proceso Distribuido, Acceso a Datos Remotos y Bases de Datos Distribuidas.";
    $post->titulo_post2_post="Definir los Conceptos de Lógica de Acceso, Presentación y Negocio a Datos."; 
    $post->titulo_post3_post="Proceso de Diseño de Lógica de Acceso a Datos, Lógica de Presentación de Datos y Lógica de Negocio o Lógica de Aplicación."; 
    $post->titulo_post4_post="Proceso de Desarrollo de Lógica de Acceso a Datos, Lógica de Presentación de Datos y Lógica de Negocio o Lógica de Aplicación. "; 
    $post->titulo_post5_post="Concepto de Nivel Vinculado a Programación Web."; 
    $post->titulo_post6_post="Proceso de Planificación en Dos Niveles."; 
    $post->titulo_post7_post="Proceso de planificación en Tres niveles."; 

    $post->fecha_publicacion_post="02.03.2022";
    $post->contenido="Portafolio de Investigaciones dedicado a la asignatura de Programación Cliente/Servidor.";
    return view('indexu2',['post'=>$post]);
})->name('indexu2');


Route::get('/indexu3', function () {
    $post= new post();
    $post->titulo_barra_post="Inicio";
    $post->titulo_barra2_post="Unidad I";
    $post->titulo_barra3_post="Unidad II";
    $post->titulo_post="Temas Unidad II";
    $post->titulo_post_post="Proceso de Planificación Multiniveles.";
    $post->titulo_post2_post="Problemas de Actualización y Mantenimiento de Aplicaciones Multinivel."; 
    $post->titulo_post3_post="Conceptos de Modelo, Control y Vista, en las Arquitecturas Cliente/Servidor."; 
    $post->titulo_post4_post="Concepto del Modelo Vista Controlador (MVC) en las Arquitecturas Cliente/Servidor. "; 
    $post->titulo_post5_post="Proceso de Flujo de control a partir del MVC, en las Arquitecturas Cliente/Servidor. "; 
    $post->titulo_post6_post="Desarrollo de Software a partir del MVC, en las Arquitecturas Cliente/Servidor."; 
    $post->titulo_post7_post="Concepto de comunicación orientada a conexión e interfaz de programación de aplicaciones (API)."; 

    $post->fecha_publicacion_post="02.03.2022";
    $post->contenido="Portafolio de Investigaciones dedicado a la asignatura de Programación Cliente/Servidor.";
    return view('indexu3',['post'=>$post]);
})->name('indexu3');

Route::get('/indexu4', function () {
    $post= new post();
    $post->titulo_barra_post="Inicio";
    $post->titulo_barra2_post="Unidad I";
    $post->titulo_barra3_post="Unidad II";
    $post->titulo_post="Temas Unidad II";
    $post->titulo_post_post="Explicar el Proceso de Comunicación y Configuración Orientada a Conexión e Interfaz de Programación de Aplicaciones (API).";
    $post->titulo_post2_post="Concepto de sockets."; 
    $post->titulo_post3_post="Proceso del Uso de Sockets en Aplicaciones Cliente/Servidor."; 
    $post->fecha_publicacion_post="02.03.2022";
    $post->contenido="Portafolio de Investigaciones dedicado a la asignatura de Programación Cliente/Servidor.";
    return view('indexu4',['post'=>$post]);
})->name('indexu4');
...
Route::get('temas',[publicaciones_controller::class, 'contenido1'])->name('temas');
Route::get('temas2',[publicaciones_controller::class, 'contenido2'])->name('temas2');
Route::get('temas3',[publicaciones_controller::class, 'contenido3'])->name('temas3');
Route::get('temas4',[publicaciones_controller::class, 'contenido4'])->name('temas4');
Route::get('temas5',[publicaciones_controller::class, 'contenido5'])->name('temas5');
Route::get('temas6',[publicaciones_controller::class, 'contenido6'])->name('temas6');
Route::get('temas7',[publicaciones_controller::class, 'contenido7'])->name('temas7');
Route::get('temas8',[publicaciones_controller::class, 'contenido8'])->name('temas8');
Route::get('temas9',[publicaciones_controller::class, 'contenido9'])->name('temas9');

Route::get('unidad2-1',[publicaciones_controller::class, 'contenido10'])->name('unidad2-1');
Route::get('unidad2-2',[publicaciones_controller::class, 'contenido11'])->name('unidad2-2');
Route::get('unidad2-3',[publicaciones_controller::class, 'contenido12'])->name('unidad2-3');
Route::get('unidad2-4',[publicaciones_controller::class, 'contenido13'])->name('unidad2-4');

Route::get('unidad2-5',[publicaciones_controller::class, 'contenido14'])->name('unidad2-5');
Route::get('unidad2-6',[publicaciones_controller::class, 'contenido15'])->name('unidad2-6');
Route::get('unidad2-7',[publicaciones_controller::class, 'contenido16'])->name('unidad2-7');
Route::get('unidad2-8',[publicaciones_controller::class, 'contenido17'])->name('unidad2-8');
Route::get('unidad2-9',[publicaciones_controller::class, 'contenido18'])->name('unidad2-9');
Route::get('unidad2-14',[publicaciones_controller::class, 'contenido23'])->name('unidad2-14');
Route::get('unidad2-15',[publicaciones_controller::class, 'contenido24'])->name('unidad2-15');
Route::get('unidad2-16',[publicaciones_controller::class, 'contenido25'])->name('unidad2-16');
Route::get('unidad2-17',[publicaciones_controller::class, 'contenido26'])->name('unidad2-17');


Route::get('unidad2-10',[publicaciones_controller::class, 'contenido19'])->name('unidad2-10');
Route::get('unidad2-11',[publicaciones_controller::class, 'contenido20'])->name('unidad2-11');
Route::get('unidad2-12',[publicaciones_controller::class, 'contenido21'])->name('unidad2-12');
Route::get('unidad2-13',[publicaciones_controller::class, 'contenido22'])->name('unidad2-13');
