    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('temas6')}}"   class="col-md-6 box-2">
                 <img src="images/6.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Ventajas y Desventajas de la Arquitectura Cliente/Servidor.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('temas8')}}"  class="col-md-6 box-2">
                 <img src="images/8.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Conceptos de Infrastructure as a Service (IAAS), Platform as a Service (PAAS), Software as a Service (SAAS).<span></span></div>
                   </div>
               </a>
                </div>
                </div>
