    ...
    <section class="blog-single">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                <a  href="{{route('single2')}}" class="col-md-6 box-2">
                 <img src="images/banner-image-2.jpg"   class="img-fluid">
                   <div class="overlay">
                    
                     <div class="text">Reconoce la evolución de los sistemas de información.<span></span></div>
                
                   </div>
               </a>
                    <a href="{{route('single3')}}" class="col-md-6 box-2">
                 <img src="images/banner-image-3.jpg"  class="img-fluid" >
                   <div class="overlay">

                     <div class="text">Definición de los conceptos de cliente y servidor.<span></span></div>
                   </div>
               </a>
