    ...
    <section class="blog-single">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('single')}}"   class="col-md-6 box-2">
                 <img src="images/banner-image-4.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Reconocer los conceptos de sistemas de información.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('single3')}}"  class="col-md-6 box-2">
                 <img src="images/banner-image-3.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Definir el los conceptos de Cliente y Servidor.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
