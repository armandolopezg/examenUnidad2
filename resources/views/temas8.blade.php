    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('temas7')}}"   class="col-md-6 box-2">
                 <img src="images/7.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Concepto de Cómputo en la Nube.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('temas9')}}"  class="col-md-6 box-2">
                 <img src="images/9.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Arquitectura Cliente/Servidor con los Modelos de Cómputo en la Nube IAAS, PAAS, SAAS.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
