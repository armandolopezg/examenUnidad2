            ...
            <div class="main-contant">
                ...
                <div class="row">
                 ...
                 <img src="images/banner-image-16.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Proceso de diagramación de componentes de la arquitectura Cliente/Servidor.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('temas2')}}"  class="col-md-6 box-2">
                 <img src="images/2.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Concepto de Programa Maestro.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
