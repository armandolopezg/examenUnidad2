            ...
            <div class="main-contant">
                <div class="row">
                    ...
                    <span>{{$post->fecha_publicacion_post}}</span>
                        ...
                        <p>{{$post->contenido_parrafo5}}</p>
                        <p>{{$post->contenido_parrafo6}}</p>
                        <p>{{$post->contenido_parrafo7}}</p>
                        <p>{{$post->contenido_parrafo8}}</p>
                        <p>{{$post->contenido_parrafo9}}</p>
                        <p>{{$post->contenido_parrafo10}}</p>
                        <p>{{$post->contenido_parrafo11}}</p>
                        <p>{{$post->contenido_parrafo12}}</p>
                ...
                <div class="row">
                 ...
                 <img src="images/banner-image-13.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Define los sistemas de conexión libre y a través de redes.<span></span></div>
                   </div>
               </a>
