    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('unidad2-2')}}"   class="col-md-6 box-2">
                 <img src="images/11.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Definir los Conceptos de Lógica de Acceso, Presentación y Negocio a Datos.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('unidad2-4')}}"  class="col-md-6 box-2">
                 <img src="images/13.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Proceso de Desarrollo de Lógica de Acceso a Datos, Lógica de Presentación de Datos y Lógica de Negocio o Lógica de Aplicación.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
