    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('unidad2-1')}}"   class="col-md-6 box-2">
                 <img src="images/10.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Presentación Distribuida, Presentación Remota, Lógica o Proceso Distribuido, Acceso a Datos Remotos y Bases de Datos Distribuidas.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('unidad2-3')}}"  class="col-md-6 box-2">
                 <img src="images/12.webp"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Proceso de Diseño de Lógica de Acceso a Datos, Lógica de Presentación de Datos y Lógica de Negocio o Lógica de Aplicación.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
