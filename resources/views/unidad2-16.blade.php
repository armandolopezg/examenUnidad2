    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('unidad2-15')}}"   class="col-md-6 box-2">
                 <img src="images/20.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Concepto del Modelo Vista Controlador (MVC) en las Arquitecturas Cliente/Servidor.<span></span></div>
                   </div>
               </a>
