                ...
                <div class="row">
                 ...
                 <img src="images/banner-image-14.jpg"  class="img-fluid">
                   <div class="overlay">
                    ...
                    <a href="{{route('single8')}}"  class="col-md-6 box-2">
                 <img src="images/banner-image-15.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Clasificar los sistemas de información de acuerdo a su arquitectura.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
