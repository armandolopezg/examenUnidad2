    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('unidad2-17')}}"   class="col-md-6 box-2">
                 <img src="images/20.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Desarrollo de Software a partir del MVC, en las Arquitecturas Cliente/Servidor.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('unidad2-11')}}"  class="col-md-6 box-2">
                 <img src="images/22.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Proceso de Comunicación y Configuración Orientada a Conexión e Interfaz de Programación de Aplicaciones (API).<span></span></div>
                   </div>
               </a>
                </div>
                </div>
