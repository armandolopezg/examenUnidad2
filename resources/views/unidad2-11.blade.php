            ...
            <div class="main-contant">
                ...
                <div class="row">
                 ...
                 <img src="images/21.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Concepto de comunicación orientada a conexión e interfaz de programación de aplicaciones (API).<span></span></div>
                   </div>
               </a>
                    <a href="{{route('unidad2-12')}}"  class="col-md-6 box-2">
                 <img src="images/23.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Concepto de sockets.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
