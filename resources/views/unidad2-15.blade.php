    ...
    <section class="blog">
        <div class="container">
            <div class="main-contant">
                ...
                <div class="row">
                    <a href="{{route('unidad2-14')}}"   class="col-md-6 box-2">
                 <img src="images/19.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Conceptos de Modelo, Control y Vista, en las Arquitecturas Cliente/Servidor.<span></span></div>
                   </div>
               </a>
                    <a href="{{route('unidad2-16')}}"  class="col-md-6 box-2">
                 <img src="images/20.jpg"  class="img-fluid">
                   <div class="overlay">
                     <div class="text">Proceso de Flujo de control a partir del MVC, en las Arquitecturas Cliente/Servidor.<span></span></div>
                   </div>
               </a>
                </div>
                </div>
